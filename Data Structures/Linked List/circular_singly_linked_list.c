...
int main()
{
    ...
    while (1)
    {
        ...
        case 3:
            printf("\n\tCIRCULAR SINGLY LINKED LIST : INSERT AT POSITION");
            printf("\nEnter data:");
            scanf("%d", &value);
        ...
        case 5:
            printf("\n\tCIRCULAR SINGLY LINKED LIST : DELETE FROM BEGINNING");
            delete_beg(&header);
            printf("\n\nThe list after this operation is displayed below:");
            display(&header);
            break;
        ...
        case 6:
            printf("\n\tCIRCULAR SINGLY LINKED LIST : DELETE FROM POSITION");
            printf("\nEnter position(The position of the node at the beginning is 1):");
            scanf("%d", &pos);
...
int delete_beg(struct node **headerPtr)
{
    ...
    if ((*headerPtr) == NULL)
    {
        printf("\nUnderflow : Circular singly linked list is empty. Nothing to delete.");
    ...
    else
    {
        ptr = (*headerPtr);
        ptr2 = (*headerPtr);
        while (ptr2->next!=(*headerPtr))
        {
            ptr2=ptr2->next;
        }
        ptr2->next=(*headerPtr)->next;
