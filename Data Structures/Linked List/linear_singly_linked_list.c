...
int main()
{
    ...
    while (1)
    {
        ...
        {
        case 1:
            printf("\n\tLINEAR SINGLY LINKED LIST : DISPLAY");
            display(&header);
            break;

        case 2:
            printf("\n\tLINEAR SINGLY LINKED LIST : INSERT AT BEGINNING");
            printf("\nEnter data:");
            scanf("%d", &value);
        ...
        case 3:
            printf("\n\tLINEAR SINGLY LINKED LIST : INSERT AT POSITION");
            printf("\nEnter data:");
            scanf("%d", &value);
        ...
        case 4:
            printf("\n\tLINEAR SINGLY LINKED LIST : INSERT AT END");
            printf("\nEnter data:");
            scanf("%d", &value);
        ...
        case 5:
            printf("\n\tLINEAR SINGLY LINKED LIST : DELETE FROM BEGINNING");
            delete_beg(&header);
            printf("\n\nThe list after this operation is displayed below:");
            display(&header);
            break;
        ...
        case 6:
            printf("\n\tLINEAR SINGLY LINKED LIST : DELETE FROM POSITION");
            printf("\nEnter position(The position of the node at the beginning is 1):");
            scanf("%d", &pos);
        ...
        case 7:
            printf("\n\tLINEAR SINGLY LINKED LIST : DELETE FROM END");
            delete_end(&header);
            printf("\n\nThe list after this operation is displayed below:");
            display(&header);
            break;
...
void display(struct node **headerPtr)
{
    ...
    if ((*headerPtr) == NULL)
    {
        printf("\nLinear singly linked list is empty.");
        return;
    }
    else
    {
...
int delete_beg(struct node **headerPtr)
{
    ...
    if ((*headerPtr) == NULL)
    {
        printf("\nUnderflow : Linear singly linked list is empty. Nothing to delete.");
    ...
    else
    {
        ...
        else
        {
            ...
            while (ptrpos < pos - 1)
            {
                ptr = ptr->next;
                ptrpos++;
                if (ptr->next == NULL /*&& ptrpos != pos*/) //header for circular
                {
                    printf("\nPosition not found in the list.");
                    return DELETE_FAILURE;
                }
